...
public class Results_Activity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Home.setOnClickListener(view -> {
            Intent Option8=new Intent(Results_Activity1.this,Home_PageActivity1.class);
            startActivity(Option8);
        });

        Profile=findViewById(R.id.PROFILE_symbol);
        Profile.setOnClickListener(view -> {
            Intent Option8=new Intent(Results_Activity1.this,V_AccountActivity1.class);
            startActivity(Option8);
        });

        Listing=findViewById(R.id.Listing_symbol);
        Listing.setOnClickListener(view -> {
            Intent Option8=new Intent(Results_Activity1.this,Candidate_ListingActivity1.class);
            startActivity(Option8);
        });

        Count=findViewById(R.id.Count_symbol);
        Count.setOnClickListener(view -> {
            Intent Option8=new Intent(Results_Activity1.this,Vote_CountingActivity1.class);
            startActivity(Option8);
        });

        Results=findViewById(R.id.Results_symbol);
        Results.setOnClickListener(view -> {
            Intent Option8=new Intent(Results_Activity1.this,Results_Activity1.class);
            startActivity(Option8);
        });
